...
public class ModularBackpackItem extends Item {
    public ModularBackpackItem(Settings item$Settings_1) {
    ...
    public TypedActionResult<ItemStack> use(World world_1, PlayerEntity playerEntity_1, Hand hand_1) {
        if (!world_1.isClient)
            ContainerProviderRegistry.INSTANCE.openContainer(Items.MODULAR_BACKPACK_CONTAINER, playerEntity_1, buf -> {
