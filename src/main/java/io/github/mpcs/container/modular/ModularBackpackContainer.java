...
public class ModularBackpackContainer extends Container {
    private final ModularBackpackInventory inv;
    private final BlockContext context;
    private final PlayerEntity player;

    public ModularBackpackContainer(int syncId, PlayerInventory playerInv) {
        this(syncId, playerInv, BlockContext.EMPTY);
    }

    public ModularBackpackContainer(int syncId, PlayerInventory playerInv, BlockContext ctx) {
        super(null, syncId);
        this.inv = new ModularBackpackInventory(this, playerInv.player);
        this.context = ctx;
